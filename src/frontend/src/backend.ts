...
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<bigint> {
    ...
    async deleteEntry(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllEntries(): Promise<Array<InstagramEntry>> {
        if (this.processError) {
            try {
    ...
    async getEntriesByArea(arg0: string): Promise<Array<InstagramEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntriesByArea(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
